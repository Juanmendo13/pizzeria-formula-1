...
- Enviar pedidos del carrito por correo a `pizzeriaformula1@outlook.es`. Resend exige un dominio propio; si falla, el cliente puede enviarlo con su correo (mailto). Opcional: `WEB3FORMS_ACCESS_KEY`.
